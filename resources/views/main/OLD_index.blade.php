...
<body>
    ...
    <div class="history">
        <h2>自己紹介</h2>
            <p>1992年11月24日、神奈川県横浜市で生まれ。<br>
            中学、高校ではバレーボール部で副主将、主将を務める。<br>
            ...
            <p>その後、Webディレクター兼SEO専門になるきっかけとなったWPのブログサイト、<a href="https://332blog.com/">332blog</a> を立ち上げる
            </p>
            <p>
                Web制作会社にて、ディレクターとして <a href="https://shisaly.com/">shisaly</a> のシステム開発ディレクターとして従事。<br>
                Webサイトを作る楽しさを知り、chatGPTを駆使して、1人でWebサイトを立ち上げ。<br>
                <a href="https://carprice-info.332web.com/">中古車買取相場データベース</a>
                <p>Laravel フレームワークを使い、pythonにてスクレイピング処理をcronにて実行。<br>
                    スクレイピングしたデータは直接DBに格納し、データを加工してLaravelと共有しているMasterテーブルに相場情報を統合するシステムを開発。
                </p>
